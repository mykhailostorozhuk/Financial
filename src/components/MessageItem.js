...
export default class MessageItem extends Component {
    ...
    render() {
        ...
        return (
            <View style={{height: 110, marginLeft: 20, marginRight: 20, backgroundColor: 'white'}}>
                ...
                <View style={[{height: 93, justifyContent: 'center', borderRadius: 10, backgroundColor: 'white'}, styles.elevationLow1]}>
                    <View style={{flexDirection: 'row', alignItems: 'center'}}>
                        ...
                        <Text style={{flex: 1, fontSize: 15, marginLeft: 15, fontFamily: "HelveticaNeue"}}>{title}</Text>
                        <Text style={{marginRight: 15, fontSize: 12, fontFamily: "HelveticaNeue"}}>{value}</Text>
                    </View>
