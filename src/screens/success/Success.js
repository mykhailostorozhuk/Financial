    ...
    render() {
        ...
        return (
            <View style={styles.slide}>
                ...
                <Text style={{width: 350, textAlign: 'center', marginTop: 15, fontSize: 12, color: '#262E49', lineHeight: 20}}>There are many variations of passages of Lorem lpsum avaiable, but the majority have suffered alteration in</Text>
